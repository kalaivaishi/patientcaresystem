        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <li class="submeny active">
                        <a href="{{url('escalate_call_list')}}"><i class="fas fa-user-md"></i> <span>Escalate Call</span><span class="badge badge-pill bg-danger float-right">{{$escalate_call_count}}</span></a>
                    </li>
