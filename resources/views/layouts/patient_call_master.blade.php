                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                      ...
                      <li class="submeny active">
                        <a href="{{url('patient_homepage')}}"><i class="fas fa-user-md"></i> <span>Patient Home Page</span></a>
                    </li>
                    <li class="submeny active">
                        <a href="{{url('nurse_homepage')}}"><i class="fas fa-user-md"></i> <span>Nurse Home Page</span></a>
                    </li>
                    <li class="submeny">
                        <a href="{{url('housekeeping_station')}}"><i class="fas fa-user"></i> <span>House Keeping</span></a>
                    </li>
                    <li class="submeny">
                        <a href="{{url('vitals')}}"><i class="fas fa-procedures"></i> <span>Vitals</span></a>
                    </li>
                    <li class="submeny ">
                        <a href="{{url('cafeteria_station')}}"><i class="fas fa-procedures"></i> <span>Cafeteria</span></a>
                    </li>
                    <li class="submeny">
                        <a href="{{url('report_admin')}}/{{1001}}"><i class="fas fa-procedures"></i> <span>Report To Admin</span></a>
                    </li>
                    <li class="submeny">
                        <a href="{{url('medication')}}"><i class="fas fa-procedures"></i> <span>Medication</span></a>
                    </li>
