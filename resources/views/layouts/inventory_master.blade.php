...
<ul>
  ...
  <li class="submeny">
    <a href="{{url('item_master')}}"><i class="fas fa-user-md"></i> <span>Item Master</span></a>
</li>
<li class="submeny">
    <a href="{{url('item_category_master')}}"><i class="fas fa-user"></i> <span>Item Category Master</span></a>
</li>
<li class="submeny">
    <a href="{{url('packaging_master')}}"><i class="fas fa-procedures"></i> <span>Packaging Master</span></a>
</li>
<li class="submeny">
    <a href="{{url('item_unit_master')}}"><i class="fas fa-stethoscope"></i> <span>Item Unit Master</span></a>
</li>
<li class="submeny">
    <a href="{{url('item_manufacturer_master')}}"><i class="fas fa-stethoscope"></i> <span>Item Manufacturer</span></a>
</li>
<li class="submeny">
    <a href="{{url('store_master')}}"><i class="fas fa-stethoscope"></i> <span> Store Master</span></a>
</li>
<li class="submeny">
    <a href="{{url('vendor_master')}}"><i class="fas fa-stethoscope"></i> <span>Vendor Master</span></a>
</li>
<li class="submeny">
    <a href="{{url('store_nursing_counter')}}"><i class="fas fa-stethoscope"></i> <span>Store Nursing Counter Mapping</span></a>
</li>
<li class="submeny">
    <a href="{{url('item_location_master')}}"><i class="fas fa-stethoscope"></i> <span>Item Location Master</span></a>
</li>
