...
<div class="row nurse_grid">
    ...
    <div class="col-md-3 col-sm-4 col-xs-6 col-lg-2" style="fill: aquamarine;">
        ...
        @elseif($bed_no->call_type_id == '5')
        <button type="button" class="btn" data-toggle="modal" data-target="#complete_escalate_call"
                                                data-uhid="{{$bed_no->UHID}}"
                                               data-admiss_id="{{$bed_no->admission_id}}"
                                                data-ward_no="{{$bed_no->ward_no}}"
                                                data-room_no="{{$bed_no->room_no}}"
        ...
        <div class="profile-widget" style="background-color: grey">
            ...
            <div class="profile-widget" style="background-color: green;">
                @endif
...
<div class="modal fade" id="complete_escalate_call" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
<div class="modal-dialog modal-xl">
 <div class="modal-content">
     <!-- Header -->
     <div class="modal-header" style="background: skyblue;">
         <h5 class="modal-title" id="complete_escalate_call" ><b> Complete Escalation Call </b></h5>
         <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
         </button>
         </div><br>
      <!-- Main block -->
                 ...
                 <div class="demo-masked-input">
                     <div class="row clearfix">
                       <div class="col-12">
                           <div class="form-group">
                               <div class="form-line">
                                   <form class="needs-validation" novalidate action="{{url('complete_escalate_call')}}" method="post">
                                      @csrf
                                   <div class="form-row row">
                                       <div class="col-md-4 ">
                                        <label>UHID</label>
                                    ...
                                    <div class="col-md-4 ">
                                     ...
                                     <div class="col-md-4 ">
                                      ...
                                      <input type="text" name="consult_descr" id="consult_descr" value="" readonly>
                                    </div>
                                    <div class="col-md-4 ">
                                        <label>Consultant Background</label>
                                      <input type="text" name="consult_backgr" id="consult_backgr" value="" readonly>
                                    </div>
                           ...
                           <div class="form-group">
                               <div class="form-line">
                                   <form class="needs-validation" novalidate action="{{url('nurse_observation')}}" method="post">
                                      @csrf
                                    <div class="form-group">
                                  <label>Respective Consultant Name</label>
                                  <input type="text" class="form-control" name="respective_consult_name" id="respective_consult_name" readonly>
                                </div>
                                   <div class="form-group">
                               ...
                               <div class="col-md-4 ">
                                ...
                                <select class="col-md-6" id="consult_id" name="consult_id">
                                     ...
                                     <input type="hidden" name="p_admiss_id" id="p_admiss_id" value="">
...
<script type="text/javascript">
    ...
    $("#nurse_id").click(function(){

        var ward_no = $('#ward_no').val();
        var nurse_id_value = $('#nurse_id_value').val();

      $.ajax({
            url:"{{url('get_single_nurse_detail')}}",
            type: "post",
            data: {
            ward_no: ward_no,
            nurse_id_value: nurse_id_value,
            _token: '{{csrf_token()}}'
            },
            dataType : 'json',
            success: function(data){
                alert(data);
              $("#bed_no").html(data.bed);
            },
            error:function(data)
            {
                console.log(data);
    ...
    $("#escalate_call").click(function(){

        var ward_no = $('#ward_no').val();

      $.ajax({
            url:"{{url('escalate_call')}}",
            type: "post",
            data: {
            ward_no: ward_no,
            _token: '{{csrf_token()}}'
  ...
  $('#complete_call').on('show.bs.modal', function(e) {
    ...
    var link     = $(e.relatedTarget)
      ...
      var admiss_id = link.data("admiss_id")
    ...
    modal.find(".modal-body #admiss_id").val(admiss_id);
...
$('#complete_escalate_call').on('show.bs.modal', function(e) {
    ...
    var link     = $(e.relatedTarget)
      ...
      $.ajax({
                ...
                success: function(data){
                  ...
                  $("#consult_descr").val(data.consult_desc);  
                  $("#consult_backgr").val(data.consult_backg);
                },
                error:function(data)
                {
                    console.log(data);
  ...
  $("#submit_escalation").click(function () {
            ...
            $.ajax({
                ...
                success: function(data){
                  ...
                  $("#respective_consult_name").val(data.name);
                },
                error:function(data)
                {
                    console.log(data);
