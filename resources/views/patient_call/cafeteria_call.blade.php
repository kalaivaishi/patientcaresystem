...
<div class="card" style="padding: 10px;">
    <div class="table-responsive">
      <h3 style="color: orangered;"><u>Cafeteria Call</u></h3>
        <table class="datatable table table-stripped ">
            <thead style="background-color: rgb(144, 144, 176);">
            <th>Cafeteria Station</th>
            <th>Patient Ward</th>
            <th>Room No</th>
            <th>Bed No</th>
            <!-- <th>Calling Unit</th> -->
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$call_detail->service_name}}</td>
            <td>@if($call_detail->status == '')
                @else
            ...
            <td>@if($call_detail->status == '')<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#complete_cafe_call"
...
<div class="modal fade" id="complete_cafe_call" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
<div class="modal-dialog modal-xl">
 <div class="modal-content">
     <!-- Header -->
     <div class="modal-header" style="background: skyblue;">
         <h5 class="modal-title" id="complete_cafe_call" ><b> Complete Call </b></h5>
                     ...
                     <div class="row clearfix">
                       <div class="col-12">
                           <div class="form-group">
                               <div class="form-line">
                                   <form class="needs-validation" novalidate action="{{url('complete_cafe_call')}}" method="post">
                                      @csrf
                                   ...
                                   <div class="col-md-4 ">
                                        ...
                                        <select class="col-md-6" id="nurse_id" name="nurse_id">
                                           ...
                                           @foreach($cafe_service as $service)
    ...
    <script src="{{'assets/js/app.js'}}"></script>
     ...
     <script>
        ...
        // document.getElementById('time').innerHTML=dateTime;
         ...
         $('#complete_cafe_call').on('show.bs.modal', function(e) {
