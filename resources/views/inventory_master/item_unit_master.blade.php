...
<div class="content">
  <button type="menu" style="font-family: monospace; width: 100%; text-align: left;" class="btn btn-primary m-t-15 waves-effect"> <b>Item Unit Mater</b></button>
...
<div class="modal-dialog modal-xl">
 <div class="modal-content">
     ...
     <div class="modal-header" style="background: skyblue;">
         <h5 class="modal-title" id="exampleModalLabel" ><b>Item Unit Master </b></h5>
                     ...
                     <div class="row clearfix">
                       <div class="col-12">
                           <div class="form-group">
                               <div class="form-line">
                                 <form method="post" action="{{url('save_item_unit')}}">
                                   @csrf
                                   <div class="form-row">
...
<script>
    function delete_item(item_unit_id){
            if(confirm('Do you want to Delete?'))
            {
            $.ajax({
                url:"{{url('delete_item_unit')}}/"+item_unit_id,
                type: "DELETE",
                data: {
                ...
                success: function(data){
                  alert(data);
                  window.location.href = "{{url('item_unit_master')}}";
                },
                error:function(data)
                {
                    console.log(data);
