...
<div class="content">
  <button type="menu" style="font-family: monospace; width: 100%; text-align: left;" class="btn btn-primary m-t-15 waves-effect"> <b>Packaging Mater</b></button>
             ...
             <table class="datatable table table-stripped ">
                   ...
                   <tbody>
                     ...
                     <tr>
                         ...
                         <td><button style="border-color: white;" id="delete_pack" onclick="delete_item({{$row->id}})"><i class="fa fa-times-circle" style="font-size: 20px;color: red;"></i></button></td>
                     </tr>
                     @endforeach
                    </tbody>
...
<div class="modal-dialog modal-xl">
 <div class="modal-content">
     ...
     <div class="modal-header" style="background: skyblue;">
         <h5 class="modal-title" id="exampleModalLabel" ><b> Packaging Master </b></h5>
                     ...
                     <div class="row clearfix">
                       <div class="col-12">
                           <div class="form-group">
                               <div class="form-line">
                                <form method="post" action="{{url('save_packaging_master')}}">
                                   @csrf
...
<script>
     function delete_item(item_pack_id){
            if(confirm('Do you want to Delete?'))
            {
            $.ajax({
                url:"{{url('delete_packaging')}}/"+item_pack_id,
                type: "DELETE",
                data: {
                ...
                success: function(data){
                  alert(data);
                  window.location.href = "{{url('packaging_master')}}";
                },
                error:function(data)
                {
                    console.log(data);
