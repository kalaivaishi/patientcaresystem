...
<div class="content">
  <button type="menu" style="font-family: monospace; width: 100%; text-align: left;" class="btn btn-primary m-t-15 waves-effect"> <b>Store Master</b></button>
   ...
   <div class="row clearfix">
       ...
       <div class="body">
        ...
        <div class="col-lg-12 col-md-12 col-sm-4 col-xs-4" style="background-color:rgb(233, 233, 233);"><br>
            <div class="row clearfix">
              <form method="post" action="{{url('save_store_master')}}">
                @csrf
                <div class="form-row own_decor_forms">
                    ...
                    <div class="col-md-4 mb-0">
                        ...
                        <input type="text" name="parent_store" class="form-control">
                    </div>
                    <div class="col-md-4 mb-0">
                         <label>Wing</label>
                    ...
                    <div class="col-md-4 mb-0">
                        ...
                        <input type="text" name="store_type" class="form-control">
                    </div>
                   
                    <div class="col-md-2 mb-0"><br>
                        <label><br>
                            <input id="indeterminate-checkbox" type="checkbox" name="main_store">
...
<script>
    function delete_store(store_id){
            ...
            {
            $.ajax({
                url:"{{url('delete_store_master')}}/"+store_id,
                type: "DELETE",
                data: {
                    store_id: store_id,
                    _token: '{{csrf_token()}}'
                ...
                success: function(data){
                  alert(data);
                  window.location.href = "{{url('store_master')}}";
                },
                error:function(data)
                {
                    console.log(data);
